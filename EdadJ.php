...
if ($edad > 0 && $edad <= 2){
    echo <<<RecienNacido
    <b><br><br>Esta edad de $edad es de un recien nacido</b>
RecienNacido; 
}

elseif ($edad > 2 && $edad <= 11){
    echo <<<EdadNiño
    <b><br><br>Esta edad de  $edad  es de un Niño</b>
EdadNiño;
}
elseif ($edad > 11 && $edad <= 18){
    echo <<<EdadAdolescente
    <b><br><br>Esta edad de $edad es de un Adolescente</b>
EdadAdolescente;
}
elseif ($edad > 19 && $edad <= 58){
    echo <<<EdadAdulto
    <b><br><br>Esta edad de  $edad es de un Adulto</b>
EdadAdulto;
}

elseif ($edad > 59 && $edad <= 120){
    echo <<<EdadAnciano
    <b><br><br>Esta edad de  $edad es de un Anciano</b>
EdadAnciano;
}
